...
import { MessageSquare, User, Loader2, Lock, Mail, EyeOff, Eye } from 'lucide-react'
...
const SignUpPage = () => {
  ...
  return (
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 mt-[30px]">
        <div className="w-full max-w-md space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="btn btn-success w-full" disabled={isSigningUp}>
              {isSigningUp ? (
                <>
